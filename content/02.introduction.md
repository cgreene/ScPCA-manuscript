...
All data provided on the portal are available in formats ready for downstream analysis with common workflow ecosystems such as `R/Bioconductor`'s `SingleCellExperiment` [@doi:10.1038/s41592-019-0654-x] or the Python-based `Scanpy` [@doi:10.1186/s13059-017-1382-0].
