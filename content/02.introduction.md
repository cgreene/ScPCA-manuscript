...
Additionally, not every institution has access to data from pediatric tumors [@doi:10.1093/jnci/djad115].
Thus, it is imperative to provide harmonized data from pediatric tumors to all pediatric cancer researchers.
