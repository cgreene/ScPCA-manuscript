...
All summarized gene expression data is available for download on the ScPCA Portal, https://scpca.alexslemonade.org/. 
We do not provide access to the raw RNA-seq data, but some projects list accession IDs on the Portal where raw data for that project can be found. 
...
- The code for development of the Portal infrastructure can be found at https://github.com/AlexsLemonade/scpca-portal. 
- All code for this Manuscript can be found at https://github.com/AlexsLemonade/scpca-paper-figures and https://github.com/AlexsLemonade/ScPCA-manuscript.
