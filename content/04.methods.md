...
In an effort to ensure sample metadata for ScPCA are compatible with CZI's CELLxGENE, ontology term identifiers were assigned to metadata categories for each sample following the guidelines present in the CELLxGENE schema [@url:https://cellxgene.cziscience.com; @url:https://github.com/chanzuckerberg/single-cell-curation/blob/main/schema/3.0.0/schema.md] as shown in {@tbl:table1}.
...
Table 1: Metadata field mapping to Ontology terms {#tbl:table1}
<!-- TODO: Table title probably needs work here! -->
