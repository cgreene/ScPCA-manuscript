...
A. Diagnostic plot showing `SingleR` cell type annotation quality, for library `SCPCL000001`.
...
B. Diagnostic plot showing `CellAssign` cell type annotation quality, for library `SCPCL000001`.
...
This example heatmap displays submitter-provided annotations to annotations with `SingleR` and `CellAssign`.
