...
<!-- Figure S3 -->
![**Processing bulk RNA-seq in `scpca-nf`.**](https://raw.githubusercontent.com/AlexsLemonade/scpca-paper-figures/main/figures/compiled_figures/pngs/figure_s3.png?sanitize=true){#fig:figs3 tag="S3" width="7in"}

<br><br>

<!-- Figure S4 -->
![**Example plots from the cell type annotation summary report of annotation quality assessments.**](https://raw.githubusercontent.com/AlexsLemonade/scpca-paper-figures/main/figures/compiled_figures/pngs/figure_s4.png?sanitize=true){#fig:figs4 tag="S4" width="7in"}

<br><br>


<!-- Figure S5 -->
![**Example heatmap from cell type annotation summary report comparing annotations across methods.**](https://raw.githubusercontent.com/AlexsLemonade/scpca-paper-figures/main/figures/compiled_figures/pngs/figure_s5.png?sanitize=true){#fig:figs5 tag="S5" width="7in"}
