...
The results from all analyses we conducted comparing Cell Ranger to `alevin-fry` are available in a public analysis repository, [`alsf-scpca`](https://github.com/AlexsLemonade/alsf-scpca). 
